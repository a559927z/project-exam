...
Page({
    ...
    data: {
        ...
        areaName: '',
        priority: '',
        addUrl: app.globalData.localhost + '/superadmin/addarea',
        modifyUrl: app.globalData.localhost + '/superadmin/modifyarea'
    },
    ...
    onLoad: function (options) {
        ...
        wx.request({
            url: app.globalData.localhost + '/superadmin/getareabyid',
